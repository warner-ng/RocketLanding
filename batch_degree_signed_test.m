function results = batch_degree_signed_test()
    close all;
    consts = get_consts();
    angles = [-20 -10 -5 -2 -1.5 -1.3 1.3 1.5 2 5 10 20];
    ...
    for k = 1:length(angles)
        ...
        fprintf('angle=%6.1f deg  t=%6.2f  J=%7.2f  y=%8.2f  z=%7.2f  th=%8.3f deg  speed=%7.2f  dth=%8.3f deg/s\n', results(k,:));
    end
end

function [dx, u] = odefun_local(t, x, wind, consts, ctrl)
    th = x(3); psi = x(4); m = x(9);
